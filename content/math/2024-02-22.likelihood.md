...
author = ["littlehome"]
date = 2024-02-22
lastmod = 2024-02-23T18:02:47+09:00
draft = false
+++
...
\\[ \\int_{-\\infty}^{\\infty} \\int_{-\\infty}^{\\infty} f_{X,Y}(x,y) \\, dx \\, dy = \\int_{-\\infty}^{\\infty} \\int_{-\\infty}^{\\infty} f_{X}(x) f_{Y}_{}(y) \\, dx \\, dy = \\int_{-\\infty}^{\\infty} f_{Y}_{}(y) \\int_{-\\infty}^{\\infty} f_{X}(x)  \\, dx \\, dy = 1 \\]
